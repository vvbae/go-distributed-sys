...
func (l *Log) Append(record *api.Record) (uint64, error) {
	...
	// if maxed current segment create new one
...
func (l *Log) Read(off uint64) (*api.Record, error) {
	...
	// segment is a fixed-size page, index file is the rows
	// if the index you re looking for is bigger than the smallest row and smaller than the biggest row
...
// create new segment as active segment
