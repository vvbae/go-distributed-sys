...
// gRPC passes a map of subconnections with info
...
// route consume RPCs to follower servers and produce RPCs to the leader server
// as we have multiple reader and one writer
