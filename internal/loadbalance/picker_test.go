...
// tests that a picker initially returns balancer.ErrNoSubConnAvailable
...
// picker picks the leader subconnection for append calls
...
// tests that the picker picks the followers subconnections in a round-robin for consume calls
